...
commda_ds = CommaDataset(dataset_type="test",
        multitask=multitask,
        ground_truth="normal", dataset_path='/data4/jessica/data/toyota', return_full=True)
nuscenes_ds = NUScenesDataset(dataset_type="test",
        multitask=multitask, max_len=20,
        ground_truth="normal", dataset_path='/data4/jessica/data/toyota')
...
p = '/data4/jessica/data/toyota/ckpts_final/ckpts_final_comma_distance_none_True_1/lightning_logs/version_2/checkpoints/epoch=63-step=15808.ckpt'
#p = '/data4/jessica/data/toyota/ckpts_final/ckpts_final_nuscenes_distance_none_True_1/lightning_logs/version_1/checkpoints/epoch=398-step=27930.ckpt'
