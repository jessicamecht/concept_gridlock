...
class NUScenesDataset(Dataset):
    def __init__(
        ...
        data_path = '/data1/jessica/data/toyota/nuscenes/test_mini_nuscenes.hfd5' if dataset_type != "val" else ('/data3/jessica/data/toyota/train_consec_nuscenes.hfd5' if dataset_type == "test" else '/data3/jessica/data/toyota/train_2_2_consec_nuscenes.hfd5')
        self.people_seqs = []
