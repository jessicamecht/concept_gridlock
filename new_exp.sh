...
python3 main.py -dataset comma -backbone resnet -ground_truth normal -train -gpu_num 1  -max_epochs 200 -task  multitask -bs 1  -dataset_path /data1/shared/jessica/data1/data/toyota/
